...
My research interests include RLHF, RLVR, AIGC, world models, and 3D human modeling. As a primary author, I have published at <strong>NeurIPS, ICLR, AAAI, and IEEE TIP</strong>. I am looking for <strong>Ph.D. opportunities starting in Fall 2027</strong> and welcome <strong>research collaborations</strong> in RL and AIGC. If you'd like to connect, feel free to reach out via 📧 <button type="button" class="contact-reveal" onclick="revealAndCopyContact(this, 'xiaofengtan@seu.edu.cn', 'Email')">Show email</button> or 💬 <button type="button" class="contact-reveal" onclick="revealAndCopyContact(this, 'txf_06_20', 'WeChat ID')">Show WeChat ID</button> 😊. You can find more about my background in my <a href="/assets/pdf/CV_Xiaofeng_Tan.pdf" target="_blank">CV</a> / <a href="/assets/pdf/CV_Xiaofeng_Tan_CN.pdf" target="_blank" style="font-family: 'Songti SC', 'STSong', 'SimSun', serif;">中文简历</a>.
<br><br>
I'm a <span class="doraemon-text"><a href="https://en.wikipedia.org/wiki/Doraemon" target="_blank"><em>Doraemon</em></a></span> fan 😺, as the little companions in the bottom corners suggest. As for my personality, GPT, Gemini, and Doubao all guess <a href="https://www.16personalities.com/intj-personality" target="_blank" rel="noopener">INTJ</a> based on my long-term chat history. Our mostly work-related conversations may skew that impression, but I share it as a starting point for understanding each other's working styles when collaborating.
</div>
