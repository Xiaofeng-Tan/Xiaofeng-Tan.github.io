...
My research interests mainly revolve around RLHF, RLVR, AIGC, and 3D Human Modeling. I am actively seeking **(1)** **research internships** at top-tier companies available after Mar. 2026, **(2)** **Ph.D. positions** for **Fall 2027** (preferably in **Hong Kong**, **Singapore**, or **America**), and **(3)** any research **collaborations**. Feel free to reach out via email, and I’d be happy to connect 😊. And if you’d like to talk about *Doraemon* 😺, that works too.
