...
<br><br>
I'm a <span class="doraemon-text"><a href="https://en.wikipedia.org/wiki/Doraemon" target="_blank"><em>Doraemon</em></a></span> fan 😺, as the little companions in the bottom corners suggest. As for my personality, GPT and Gemini both guess <a href="https://www.16personalities.com/intj-personality" target="_blank" rel="noopener">INTJ</a> based on my long-term chat history. Our mostly work-related conversations may skew that impression, but I share it as a starting point for understanding each other's working styles when collaborating.
</div>
